...
import 'package:flix/presentation/subscribe_popup_dialog/subscribe_popup_dialog.dart';
import 'package:flix/presentation/payment_succesful_popup_dialog/payment_succesful_popup_dialog.dart';
import 'package:flix/presentation/download_movie_pop_up_dialog/download_movie_pop_up_dialog.dart';
...
import 'package:flix/presentation/logout_dialog/logout_dialog.dart';
...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapEpisodeTabContainer(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapDownloadMoviePopup(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapHomeRecentlyWatched(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapEmptyStateDownloadedTabContainer(
                                                  context);
                                            },
                                            child: Container(
                                                decoration:
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "Empty State Downloaded - Tab Container",
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  textAlign:
  ...
  onTapResetPasswordSuccess(BuildContext context) {
  ...
  onTapCategoryComedy(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.categoryComedyScreen);
  }

  onTapEpisodeTabContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.episodeTabContainerScreen);
  }

  onTapSubscribepopup(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
              content: SubscribePopupDialog(),
  ...
  onTapChoosePlan(BuildContext context) {
  ...
  onTapPaymentSuccesfulPopup(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
  ...
  onTapDownloadMoviePopup(BuildContext context) {
    showDialog(
        context: context,
  ...
  onTapHomeRecentlyWatched(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.homeRecentlyWatchedScreen);
  }
  ...
  onTapNotFound(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.notFoundScreen);
  }

  onTapDeletePopup(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
  ...
  onTapEmptyStateDownloadedTabContainer(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.emptyStateDownloadedTabContainerScreen);
  }

  onTapSelectSaved(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.selectSavedScreen);
  }

  onTapDeletefromSaved(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
  ...
  onTapSavedempty(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.savedEmptyScreen);
  }
  ...
  onTapNoNotification(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.noNotificationScreen);
  }
  ...
  onTapHistoryDelete(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
  ...
  onTapNoHistory(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.noHistoryScreen);
  }
  ...
  onTapSearchHelp(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchHelpScreen);
  }
