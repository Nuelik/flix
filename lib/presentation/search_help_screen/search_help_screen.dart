...
class SearchHelpScreen extends StatefulWidget {
  const SearchHelpScreen({super.key});

  @override
  State<SearchHelpScreen> createState() => _SearchHelpScreenState();
}

class _SearchHelpScreenState extends State<SearchHelpScreen> {
                ...
                child: Column(
                    ...
                    children: [
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          CustomAppBar(
                                              ...
                                              centerTitle: true,
                                              title: const AppbarTitle(text: "Help")),
                                          CustomSearchView(
                                              focusNode: FocusNode(),
                                              controller: groupController,
                                              hintText: "How to subscribe",
                      ...
                      Align(
                          ...
                          child: Container(
                              margin: getMargin(
                                  left: 25, top: 20, right: 25, bottom: 5),
                              padding: getPadding(
                                                      ...
                                                      child: RichText(
                                                          text: TextSpan(
                                                              children: [
                                                                ...
                                                                TextSpan(
                                                                    text:
                                                                        "contact customer support movistart",
                                                                    style: TextStyle(
                                                                        color: ColorConstant
                                                                            .blueGray100,
                                                                        fontSize:
