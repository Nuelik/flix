...
class PaymentSuccesfulPopupDialog extends StatefulWidget {
  const PaymentSuccesfulPopupDialog({super.key});

  @override
  State<PaymentSuccesfulPopupDialog> createState() =>
      _PaymentSuccesfulPopupDialogState();
}

class _PaymentSuccesfulPopupDialogState
    extends State<PaymentSuccesfulPopupDialog> {
