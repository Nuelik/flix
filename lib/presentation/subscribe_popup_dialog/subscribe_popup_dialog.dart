...
class SubscribePopupDialog extends StatefulWidget {
  const SubscribePopupDialog({super.key});

  @override
  State<SubscribePopupDialog> createState() => _SubscribePopupDialogState();
}

class _SubscribePopupDialogState extends State<SubscribePopupDialog> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        padding: getPadding(left: 31, top: 34, right: 31, bottom: 34),
        ...
        child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Text("Be a premium user and get more features",
                      maxLines: null,
                      textAlign: TextAlign.center,
                      style: AppStyle.txtPoppinsMedium18WhiteA700ab)),
              Container(
                  margin: getMargin(left: 19, top: 31, right: 19),
                  ...
                  child: Column(
                      ...
                      children: [
                        CustomCheckbox(
                            ...
                            value: isCheckbox,
                            fontStyle:
                                CheckboxFontStyle.poppinsRegular12WhiteA700a2_1,
                            onChange: (value) {
                              isCheckbox = value;
                            }),
                        CustomCheckbox(
                        ...
                        CustomCheckbox(
                            text: "Cancel anytime and anywhere",
                            value: isCheckbox2,
              ...
              CustomButton(
                  ...
                  text: "Subscribe",
                  margin: getMargin(top: 35, bottom: 2),
                  onTap: () {
